 ...
 * @typedef {import('hast').Properties} HProperties
 * @typedef {List & { data?: HProperties }} ListWithProperties
 *
 ...
 *   `hast-util-sanitize`.
 * @property {HProperties} [parentListMdastDataProps=null]
 *   Add a prefix to links to headings in the table of contents.
 */
...
export function contents(map, settings) {
  ...
  const table = {
    ...
    spread: false,
    children: [],
    data: settings.parentListMdastDataProps
  }
  if (!table.data) {
    delete table.data
  }
